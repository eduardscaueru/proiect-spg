...
void main() {
    vec3 deep_wave_albedo    = vec3(0, 0.188, 0.743),
         shallow_wave_albedo = vec3(0.552, 0.612, 1);
    ...
    float wave_ripple = snoise(0.5 * position + ripd);
    wave_ripple += 0.5*snoise(4 * position + ripd / 2);
